...
// No component import here — see `./variants.ts` and hero/block.ts's header comment. The
// variant union is derived from `variantNames`; hero/block.ts explains why writing that
